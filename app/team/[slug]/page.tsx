...
{/* Back Button - Separated and Positioned Clearly */}
{/* Back Button - Slightly Higher & Left-Aligned */}
<div className="container mx-auto px-6 pt-6 pb-2">
  <Link href="/#team">
    <Button
      variant="ghost"
      className="rounded-xl bg-gradient-to-r from-sky-50 to-blue-100 text-sky-700 hover:text-sky-900 shadow hover:shadow-md hover:scale-[1.03] transition-all duration-300 group"
    >
                ...
                <Card className="sticky top-8 shadow-2xl border-0 overflow-hidden bg-white/95 backdrop-blur-sm">
                  <div className="relative">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 flex gap-3">
                      <Button size="sm" className="flex-1 bg-white/95 hover:bg-white text-sky-600 border-0 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-[1.02]">
                        <Mail className="h-4 w-4 mr-2" />
                        Email
                      </Button>
                      <Button size="sm" variant="outline" className="bg-white/95 hover:bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-[1.02]">
                  ...
                  <CardContent className="p-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                      {getExpertiseAreas(member.position).map((area, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-4 p-5 bg-gradient-to-r from-sky-50 to-blue-50 rounded-xl border border-sky-100 hover:shadow-md transition-all duration-200 hover:scale-[1.01]"
                        >
